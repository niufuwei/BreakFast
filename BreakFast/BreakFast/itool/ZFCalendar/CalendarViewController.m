...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([model.Chinese_calendar isEqualToString:@"已订餐"])
    {
        UIAlertView * alert = [[UIAlertView alloc] initWithTitle:nil message:@"当天已订餐，请选择其他日期。" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
    }
