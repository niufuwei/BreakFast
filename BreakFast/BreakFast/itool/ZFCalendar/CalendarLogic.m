...
#pragma mark --
#pragma mark 这里写是否选择今天送餐
    
    NSLog(@"%lu--%lu---%lu",(unsigned long)calendarDay.year,(unsigned long)calendarDay.month,(unsigned long)calendarDay.day);
    calendarDay.Chinese_calendar = solarYear_arr[1];
    
    if(calendarDay.year ==2015 && calendarDay.month >=2 && (calendarDay.day == rand()%30))
    {
        calendarDay.Chinese_calendar = @"已订餐";
        
    }
    else
    {
        calendarDay.Chinese_calendar = @"无";
    }
